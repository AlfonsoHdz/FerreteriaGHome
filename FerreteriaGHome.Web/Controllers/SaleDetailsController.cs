...
namespace FerreteriaGHome.Web.Controllers
{
    public class SaleDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nameV,Date,priceV")] SaleDetail saleDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nameV,Date,priceV")] SaleDetail saleDetail)
        {
            if (id != saleDetail.Id)
            {
                return NotFound();
