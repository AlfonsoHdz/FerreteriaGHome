...
namespace FerreteriaGHome.Web.Controllers
{
    public class ShoppingDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,descripcionDC,costC,Quantity,DateShoppingDC")] ShoppingDetail shoppingDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,descripcionDC,costC,Quantity,DateShoppingDC")] ShoppingDetail shoppingDetail)
        {
