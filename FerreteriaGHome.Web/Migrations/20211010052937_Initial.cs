        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ShoppingDetails_ShoppingDetailId",
                        column: x => x.ShoppingDetailId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shoppings_ShoppingDetails_ShoppingDetailId",
                        column: x => x.ShoppingDetailId,
                        principalTable: "ShoppingDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleDetails_Products_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sales_SalesAgents_SalesAgentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ShoppingDetailId",
                table: "Products",
                column: "ShoppingDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleDetails_ProductsId",
                table: "SaleDetails",
                column: "ProductsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shoppings_ShoppingDetailId",
                table: "Shoppings",
                column: "ShoppingDetailId");
        }
